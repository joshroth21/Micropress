...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('fontawesome', get_template_directory_uri() . '/assets/js/lib/fontawesome-all.min.js', array(), '5.0.6'); // FontAwesome
...
function html5blank_styles()
{
    ...
    wp_register_style('vendor', get_template_directory_uri() . '/vendor.min.css', array(), '1.0', 'all');
    wp_enqueue_style('vendor'); // Enqueue it!
}
